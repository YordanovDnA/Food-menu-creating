...
<div class="bg-mydark border pt-5 pb-2 fixed">
        <header class="container">
            <nav class="">
                <ul class="nav nav-justify justify-content-center nav-expand-sm ">
                    <li class="nav-item"><a href="chicken_index.php" class=" active btn-top nav-link text-uppercase btn btn-outline-success text-light m-1" >Пилешки</a></li>
                    ...
                    <li class="nav-item"><a href="../lamb/lamb_index.php" class=" btn-top nav-link text-uppercase btn btn-outline-success text-light m-1">Агнешки</a></li>
    ...
    <?php
       include 'table_chicken.php';
    ?>
    <?php
        include 'inc_form_chicken.html';
    ?>
</body>
</html>