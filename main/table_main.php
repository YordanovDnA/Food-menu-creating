...
<?php
    ...
    echo "<h2 class='text-center'>Таблица - Основни Ястия</h2>";
        ...
        while($row = $result->fetch_assoc()){
            ...
            echo '
                <tr>
                    ...
                    <form class="collapse" id="edit-name-'.$IDno.'" action="update_main_table.php" method="post">
                    ...
                    <form class="collapse" id="edit-grams-'.$IDno.'" action="update_main_table.php" method="post">
                    ...
                    <form class="collapse" id="edit-price-'.$IDno.'" action="update_main_table.php" method="post">
                    <input style="width:4rem;" name="new-price" value='.$Price.'>
                    <input type="hidden" name="id" value='.$IDno.'>
                    <input class="btn-sm btn-success" type="submit" value="Промени"></form></td>
                    <td><a onclick="return confirm('.$question.')" class="btn btn-danger" href="delete_main.php?id='.$IDno.'" >Изтрий</a></td>
                </tr>
            ';
        }
        echo "</table>";
